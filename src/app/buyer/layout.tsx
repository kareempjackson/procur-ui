            ...
            <div style={{ maxWidth: 1300, margin: "0 auto", padding: "0 20px" }}>
              <div className="v6-ft-top" style={{ padding: "80px 0 64px" }}>
                ...
                <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                  <Link href="/buyer" style={{ padding: "12px 28px", background: "#f5f1ea", color: "#1c2b23", fontSize: 13, fontWeight: 700, borderRadius: 999, textDecoration: "none" }}>
                    Browse marketplace
                  </Link>
              ...
              <div className="v6-ft-row" style={{ display: "flex", gap: 60, padding: "48px 0 40px" }}>
                ...
                <div className="v6-ft-cols" style={{ flex: 1, display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 20 }}>
                  {[
                    { title: "Platform", links: [{ label: "Browse Produce", href: "/buyer" }, { label: "For Suppliers", href: "/signup?accountType=seller" }, { label: "For Buyers", href: "/signup?accountType=buyer" }, { label: "Log in", href: "/login" }] },
