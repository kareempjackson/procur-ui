...
export default function GovernmentProgressIndicator({
  currentStep,
  totalSteps,
  onStepClick,
      ...
      <div className="max-w-4xl mx-auto px-6 py-4">
        ...
        <div className="md:hidden">
          ...
          <div className="w-full bg-[var(--secondary-soft-highlight)]/30 rounded-full h-2">
            <div
              className="bg-[var(--secondary-muted-edge)] h-2 rounded-full transition-all duration-500 ease-out"
                  ...
                  className={`
                    ...
                    ${
                      isCompleted
                        ...
                        : isCurrent
                        ? "bg-[var(--secondary-muted-edge)] text-white ring-4 ring-[var(--secondary-muted-edge)]/20"
                  ...
                  className={`
                    ...
                    ${
                      isCurrent
                        ...
                        : "text-[var(--secondary-muted-edge)]/60"
                    }
                  `}
                >
                  {stepLabels[index]}
