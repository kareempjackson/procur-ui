        ...
        <section className="mb-20">
          <div className="md:columns-2 md:gap-10">
            <p className="text-lg text-gray-700 leading-8 first-letter:text-5xl first-letter:font-bold first-letter:float-left first-letter:mr-3 first-letter:leading-[0.9]">
              Successful procurement isn't about buying products — it&apos;s
              about building systems that consistently deliver quality, value,
              and reliability. Every decision you make, from supplier selection
              to payment terms, impacts your bottom line and your customers'
            ...
            <blockquote className="mt-8 md:mt-10 border-l-4 border-[var(--primary-accent2)] pl-5 italic text-xl text-gray-800">
              "Great procurement isn't about finding the cheapest option —
              it&apos;s about finding the right balance of quality, cost, and
              reliability."
            </blockquote>
          </div>
        </section>
