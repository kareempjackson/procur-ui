        ...
        <section className="mb-20">
          <div className="md:columns-2 md:gap-10">
            <p className="text-lg text-gray-700 leading-8 first-letter:text-5xl first-letter:font-bold first-letter:float-left first-letter:mr-3 first-letter:leading-[0.9]">
              ...
              don&apos;t know where your orders are, when they'll arrive, or
              what condition they'll be in, you can&apos;t plan effectively,
              serve customers reliably, or manage inventory efficiently. That's
              why we've built the most comprehensive order tracking system in
              the industry.
            </p>
            <p className="mt-6 text-lg text-gray-700 leading-8">
              ...
              and direct communication with suppliers ensure you&apos;re never
              left wondering about your critical orders.
            </p>
            <blockquote className="mt-8 md:mt-10 border-l-4 border-[var(--primary-accent2)] pl-5 italic text-xl text-gray-800">
              "Visibility isn't just about knowing where your order is —
              it&apos;s about having the confidence to run your business
              better."
            </blockquote>
          </div>
        </section>
